...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lilizing/LeoCommon"
  ...
  s.source       = { :git => "https://github.com/lilizing/LeoCommon.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LeoCommon/LeoCommon/**/*.{h,m,swift}"
