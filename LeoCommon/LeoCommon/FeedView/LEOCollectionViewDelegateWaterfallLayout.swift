//
//  LEOCollectionViewWaterfallLayout.swift
//  PinterestSwift
//
...
@objc public protocol LEOCollectionViewDelegateWaterfallLayout: UICollectionViewDelegate {
    
    func leo_collectionView (_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
                         sizeForItemAtIndexPath indexPath: IndexPath) -> CGSize
    
    @objc optional func leo_collectionView (_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
...
public enum LEOCollectionViewWaterfallLayoutItemRenderDirection: Int {
    case leoCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
    case leoCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight
    case leoCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft
}

public  let LEOCollectionElementKindSectionHeader = "LEOCollectionElementKindSectionHeader"
public  let LEOCollectionElementKindSectionFooter = "LEOCollectionElementKindSectionFooter"
public class LEOCollectionViewWaterfallLayout: UICollectionViewLayout {
    ...
    public var itemRenderDirection: LEOCollectionViewWaterfallLayoutItemRenderDirection {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public weak var delegate: LEOCollectionViewDelegateWaterfallLayout? {
        get {
            return self.collectionView!.delegate as? LEOCollectionViewDelegateWaterfallLayout
        }
    }
    ...
    override public init() {
        ...
        self.itemRenderDirection =
            LEOCollectionViewWaterfallLayoutItemRenderDirection.leoCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
    ...
    public func columnCountForSection (_ section: Int) -> Int {
        if let columnCount = self.delegate?.leo_collectionView?(self.collectionView!, layout: self, columnCountForSection: section) {
            return columnCount
        } else {
    ...
    public func itemWidthInSectionAtIndex (_ section: Int) -> CGFloat {
        ...
        if let sectionInsets = self.delegate?.leo_collectionView?(self.collectionView!, layout: self, insetForSectionAtIndex: section) {
    ...
    override public func prepare() {
        ...
        for section in 0 ..< numberOfSections {
            ...
            if let miniumSpaceing = self.delegate?.leo_collectionView?(self.collectionView!, layout: self, minimumInteritemSpacingForSectionAtIndex: section) {
            ...
            if let insets = self.delegate?.leo_collectionView?(self.collectionView!, layout: self, insetForSectionAtIndex: section) {
            ...
            if let height = self.delegate?.leo_collectionView?(self.collectionView!, layout: self, heightForHeaderInSection: section) {
                heightHeader = height
            } else {
            ...
            if heightHeader > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: LEOCollectionElementKindSectionHeader, with: IndexPath(row: 0, section: section))
            ...
            for idx in 0 ..< itemCount {
                ...
                let itemSize = self.delegate?.leo_collectionView(self.collectionView!, layout: self, sizeForItemAtIndexPath: indexPath)
            ...
            if let height = self.delegate?.leo_collectionView?(self.collectionView!, layout: self, heightForFooterInSection: section) {
                footerHeight = height
            } else {
            ...
            if footerHeight > 0 {
                attributes = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: LEOCollectionElementKindSectionFooter, with: IndexPath(item: 0, section: section))
    ...
    override public func layoutAttributesForSupplementaryView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes {
        ...
        if elementKind == LEOCollectionElementKindSectionHeader {
            attribute = self.headersAttributes[indexPath.section]
        } else if elementKind == LEOCollectionElementKindSectionFooter {
